...
Column {
        ...
        ComboBox {
            ...
            delegate: ItemDelegate {
                ...
                contentItem: Text {
                    ...
                    color: selectUser.highlightedIndex === index ? root.palette.highlight.hslLightness >= 0.7 ? "#000000ff" : "white" : root.palette.window.hslLightness >= 0.8 ? root.palette.highlight.hslLightness >= 0.8 ? "#000000ff" : root.palette.highlight : "white"
    ...
    Item {
        ...
        Button {
            ...
            contentItem: Text {
                text: parent.text
                color: config.OverrideLoginButtonTextColor != "" ? config.OverrideLoginButtonTextColor : root.palette.highlight.hslLightness >= 0.7 ? "#000000ff" : "white"
